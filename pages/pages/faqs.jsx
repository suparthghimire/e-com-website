  ...
  return (
    <main className="main faq">
      ...
      <div
        ...
        style={{ backgroundImage: "url(images/page-header/faq.jpg)" }}
      >
        <h3 className="page-subtitle lh-1">Frequently</h3>
        <h1 className="page-title font-weight-bold text-capitalize lh-1">
          Asked Questions
        </h1>
      </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-6 mt-10">
                  <h2 className="title pl-2 pr-2 ls-m text-left">
                    Customer Management
                  </h2>

                  <Accordion adClass="accordion-border accordion-boxed accordion-plus">
                    <Card
                      title="How can add vendor role to the customer?"
                      expanded={true}
                    >
                      <p className="mb-0">
                ...
                <div className="col-md-6 mt-10">
                  ...
                  <Accordion adClass="accordion-border accordion-boxed accordion-plus">
                    <Card
                      title="What is difference between simple & variable product?"
                      expanded={true}
                    >
                      <p className="mb-0">
                        Lorem ipsum dolor sit amet, consectetuer adipiscing
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-6 mt-10">
                  ...
                  <Accordion adClass="accordion-border accordion-boxed accordion-plus">
                    <Card
                      title="How can a guest order the product?"
                      expanded={true}
                    >
                      <p className="mb-0">
                        Lorem ipsum dolor sit amet, consectetuer adipiscing
                ...
                <div className="col-md-6 mt-10">
                  ...
                  <Accordion adClass="accordion-border accordion-boxed accordion-plus">
                    <Card
                      title="How can I return an purchased item online?"
                      expanded={true}
                    >
                      <p className="mb-0">
                        Lorem ipsum dolor sit amet, consectetuer adipiscing
