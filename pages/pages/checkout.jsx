          ...
          {cartList.length > 0 ? (
            <>
              <div className="card accordion">
                <Card
                  type="parse"
                  title="<div className='alert alert-light alert-primary alert-icon mb-4 card-header'>
                            <i className='fas fa-exclamation-circle'></i> <span className='text-body'>Returning customer?</span> <a href='#' className='text-primary collapse'>Click here to login</a>
                        </div>"
                >
