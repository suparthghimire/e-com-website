...
function PostEight( props ) {
    const { post, adClass = 'mb-7', isLazy = false, isOriginal = false, btnText = "Read more", btnAdClass = '', contentClass = '' } = props;
    ...
    return (
        <div className={ `post post-frame ${ post.type === 'video' ? 'post-video' : '' } ${ adClass }` }>
            ...
            <div className="post-details">
                ...
                <p className={ `post-content ${ contentClass }` }>{ post.content }</p>
