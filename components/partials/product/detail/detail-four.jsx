    ...
    <div className="product-details row pl-0">
      <div className="col-md-6">
        ...
        <ul className="product-status mt-4 mb-4 list-type-check list-style-none pl-0">
          ...
          <li>
            Tdio vulputate eleifend in in tortor. ellus massa.Dristique
            sitiismonec.
          </li>
          <li>
            Massa ristique sit amet condim vel, facilisis quimequistiqutiqu amet
            condim.
          </li>
        </ul>
      </div>
      ...
      <div className="col-md-6 pl-2">
        <div className="product-price">
          {product.data.price[0] !== product.data.price[1] ? (
            ...
            <>
              <ins className="new-price">
                ${toDecimal(product.data.salePrice)}
              </ins>
