...
function BlogSidebar() {
  ...
  return (
    <div className="col-lg-3 right-sidebar sidebar-fixed sticky-sidebar-wrapper">
      ...
      <StickyBox offsetTop={60} className="blog-sidebar-wrapper">
          ...
          {!loading && recent ? (
            <>
              ...
              <div className="widget widget-collapsible border-no">
                <Card
                  title="<h3 className='widget-title border-no'>Blog Categories<span className='toggle-btn p-0 parse-content'></span></h3>"
                  type="parse"
                  expanded={true}
                >
                  <ul className="widget-body filter-items search-ul">
                    ...
                    <li
                      className={`${
                        query.category === "lifestyle" ? "active" : ""
                      }`}
                    >
                      <ALink
                        href={{
                    ...
                    <li
                      className={`${
                        query.category === "shopping" ? "active" : ""
                      }`}
                    >
                      <ALink
                        href={{
              ...
              <div className="widget widget-collapsible">
                <Card
                  title="<h3 className='widget-title'>Popular Posts<span className='toggle-btn p-0 parse-content'></span></h3>"
                  type="parse"
                  expanded={true}
                >
              ...
              <div className="widget widget-collapsible">
                <Card
                  title="<h3 className='widget-title'>About us<span className='toggle-btn p-0 parse-content'></span></h3>"
                  type="parse"
                  expanded={true}
                >
                  <ul className="widget-body">
              ...
              <div className="widget widget-collapsible widget-posts">
                <Card
                  title="<h3 className='widget-title'>Tag Cloud<span className='toggle-btn p-0 parse-content'></span></h3>"
                  type="parse"
                  expanded={true}
                >
                  <ul className="widget-body">
                    <ALink href="#" className="tag">
                      Bag
                    </ALink>
                    <ALink href="#" className="tag">
                      Classic
