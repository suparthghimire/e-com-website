...
export default function LoginForm() {
  ...
  return (
    <div>
      {serverError.message && (
        <div className="alert alert-danger mb-2">Error: {serverError?.message.detail}</div>
      )}
      <form onSubmit={handleSubmit(handle_login)}>
        <div className="form-group mb-3">
          ...
          />
          {errors.email && <small className="error-msg">Email Cannot be Empty</small>}
        </div>
        <div className="form-group">
          ...
          />
          {errors.email && <small className="error-msg">Password Cannot be Empty</small>}
        </div>
