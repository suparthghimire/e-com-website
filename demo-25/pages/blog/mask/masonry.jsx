            ...
            <div className="page-content pb-10 mb-10">
                <div className="container">
                    <ul className="nav-filters filter-underline blog-filters justify-content-center">
                        <li><ALink href={ { pathname: `/blog/mask/masonry`, query: { category: '' } } } className={ `nav-filter ${ currentCategory === '' || currentCategory === null ? 'active' : '' } ` } scroll={ false }>All</ALink><span>15</span></li>
                        ...
                        <li><ALink href={ { pathname: `/blog/mask/masonry`, query: { category: 'shopping' } } } className={ `nav-filter ${ currentCategory === 'shopping' ? 'active' : '' } ` } scroll={ false }>Shopping</ALink><span>0</span></li>
                        <li><ALink href={ { pathname: `/blog/mask/masonry`, query: { category: 'sport' } } } className={ `nav-filter ${ currentCategory === 'sport' ? 'active' : '' } ` } scroll={ false }>Sport</ALink><span>4</span></li>
                        ...
                        <li><ALink href={ { pathname: `/blog/mask/masonry`, query: { category: 'travel' } } } className={ `nav-filter ${ currentCategory === 'travel' ? 'active' : '' } ` } scroll={ false }>Travel</ALink><span>3</span></li>
