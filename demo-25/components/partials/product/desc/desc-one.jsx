...
function DescOne ( props ) {
    const { product, isGuide = true, isDivider = true, openModal, isShipping = false } = props;
                    ...
                    <div className="row mt-6">
                        ...
                        <div className="col-md-6 pl-md-6 pt-4 pt-md-0">
                            ...
                            <figure className="p-relative d-inline-block mb-3">
                                <img src="./images/product.jpg" width="559" height="370"
                                    alt="Product" />
                    ...
                    isShipping ?
                        <TabPanel className="tab-pane product-tab-shipping">
                            ...
                            <p className="mb-0">We deliver to over 100 countries around the world. For full details of
									the delivery options we offer, please view our <ALink href="#" className="text-primary">Delivery
										information</ALink><br />We hope you’ll love every
									purchase, but if you ever need to return an item you can do so within a month of
									receipt. For full details of how to make a return, please view our <br /><ALink href="#" className="text-primary">Returns information</ALink></p>
                        </TabPanel> : ''
                }
